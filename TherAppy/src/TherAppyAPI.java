...
public interface TherAppyAPI {
  ...
  /**
   * FIXME - this method updated by Jeff and Mukhi on 8/1
   * This method inserts a user's responses to one of the 5 questions related to style pref into the database.
...
//  Therapist getTherapist(String lastName, String firstName);
